...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <p>
        &nbsp;</p>
    <p style="width: 758px; height: 32px">
        &nbsp;</p>
    <p style="width: 858px; height: 32px">
        &nbsp;</p>
    <p style="width: 858px; height: 34px">
        &nbsp;</p>
    <p style="width: 858px; height: 32px">
        &nbsp;</p>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    ...
    <img id = "frame" src="http://www.etc.cmu.edu/projects/up-plus/images/frame.png" style="position:absolute; left:275px; top:100px; width:250px; height:500px; z-index:-1">;
    <img id = "Img1" src="http://www.etc.cmu.edu/projects/up-plus/images/frame.png" style="position:absolute; left:575px; top:100px; width:250px; height:500px; z-index:-1">;
    <img id = "Img2" src="http://www.etc.cmu.edu/projects/up-plus/images/frame.png" style="position:absolute; left:875px; top:100px; width:250px; height:500px; z-index:-1">;
    </body>
</html>
