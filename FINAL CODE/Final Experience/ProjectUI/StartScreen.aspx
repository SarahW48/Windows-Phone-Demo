...
<script language="javascript" type="text/javascript">
    /* Summary: the basic interactive functions and tweak in 
     *          the startscreen page
     */
    var picid_num = 13;
    // Load the page and show the tweak button 
    ...
    // Generate the id for the live tile 
    function generateid() {
    ...
    $(function () {
        ...
        $(".apps").click(function () {
            ...
            // Show the small tile options 
                ...
                // Get the file path for later use
                ...
                var j = 0;
                var k = 0;
                // Start from index 1 for those categories 
                ...
                // Put in the apps from the same category in the recommanded apps options 
                for (var i = 0; i < 8; i++) {
        ...
        // Submit the input into the form for backend processing 
        ...
        // Show the description words for the app 
        ...
        // Show the description words for the app in the tweak field 
