    ...
    public class GenerateTiles
    {
        public Tile[] generateTile(Dictionary<int, String[]> info, string name1, string name2)
        {
            ...
            for (int j = 0; j < large.Length; j++)
            {
                if (CutString(large[j])[0] == "http://www.etc.cmu.edu/projects/up-plus/images/tiles/buildin/hotmail_L.png")
                {
                    tiles[j] = new Tile(CutString(large[j])[0],
                                   ...
                                   CutString(large[j])[3],
                                   CutString(large[j])[4],
                                   name1, name2, text[0], 0, CutString(large[j])[5]);
                }
                else
                {
                    pic_cnt++;
                    tiles[j] = new Tile(CutString(large[j])[0],
                                    ...
                                    CutString(large[j])[3],
                                    CutString(large[j])[4],
                                    null, null, null, pic_cnt, CutString(large[j])[5]);
                }
            }
            int index = 0;
            for (int j = large.Length; j < large.Length + medium.Length; j++)
            {
                if ((CutString(medium[index])[0] == "http://www.etc.cmu.edu/projects/up-plus/images/tiles/buildin/phonecall_M.png") | (CutString(medium[index])[0] == "http://www.etc.cmu.edu/projects/up-plus/images/tiles/buildin/message_M.png"))
                {
                    tiles[j] = new Tile(CutString(medium[index])[0],
                                ...
                                null, null, null, 0, CutString(medium[index])[0]);
                ...
                tiles[j] = new Tile(CutString(medium[index])[0],
                                ...
                                CutString(medium[index])[3],
                                CutString(medium[index])[4],
                                null, null, null, pic_cnt, CutString(medium[index])[5]);
                }
                index++;
            }
            index = 0;
            if (small != null)
            {
                ...
                {
                    if ((CutString(small[index])[0] == "http://www.etc.cmu.edu/projects/up-plus/images/tiles/buildin/phonecall_S.png") | (CutString(small[index])[0] == "http://www.etc.cmu.edu/projects/up-plus/images/tiles/buildin/message_S.png"))
                    {
                        tiles[j] = new Tile(CutString(small[index])[0],
                                        ...
                                        CutString(small[index])[3],
                                         ...
                                         null, null, null, 0, CutString(small[index])[0]);
                    ...
                    tiles[j] = new Tile(CutString(small[index])[0],
                                        ...
                                        CutString(small[index])[3],
                                         CutString(small[index])[4],
                                         null, null, null, pic_cnt, CutString(small[index])[5]);
                    }
                    index++;
