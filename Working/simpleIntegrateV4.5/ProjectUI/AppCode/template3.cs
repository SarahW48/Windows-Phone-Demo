...
namespace ProjectUI.AppCode
{
    public class template3
    {
        ...
        {
            new Startpoint(0,0),new Startpoint(1,0),new Startpoint(0,1),new Startpoint(1,1),new Startpoint(0,2),new Startpoint(1,2),
            new Startpoint(0,3),new Startpoint(1,3),new Startpoint(0,6),new Startpoint(1,6),new Startpoint(2,6),new Startpoint(3,6)
        };
        Startpoint[] pre_medium = new Startpoint[2]
        {
            new Startpoint(2,0),new Startpoint(2,2)
        };
