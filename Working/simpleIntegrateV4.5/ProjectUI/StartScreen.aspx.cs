...
public partial class StartScreen : System.Web.UI.Page
{
    ...
    private void Page_Load(object sender, EventArgs e)
    {
        ...
        //GetChoices();     
            ...
            starscreentiles.InnerHtml += "<img id = \"frame\" src=\"http://www.etc.cmu.edu/projects/up-plus/images/frame.png\" style=\"position:absolute; left:575px; top:190px; width:250px; height:500px\">";
            starscreentiles.InnerHtml += "<div style=\"position:absolute; left:595px; top:272px; clip:rect(0px,211px,317px,0px); z-index:1\"><div id= \"pichi\" style=\"position:absolute; left:0px; top:0px\"> <img id = \"pic2\" src=\"http://www.etc.cmu.edu/projects/up-plus/journey_images/0female.png\" style=\"width:211px; height:317px\"></div></div>";
            //Response.Write("<div style=\"position:absolute; left:350px; top:100px; clip:rect(0px,211px,317px,0px); z-index:1\"><div id= \"pichi\" style=\"position:absolute; left:0px; top:0px\"> <img id = \"pic2\" src=\"http://www.etc.cmu.edu/projects/up-plus/journey_images/" + user + ".png\" style=\"width:211px; height:317px\"></div></div>");
            //Response.Write("<img id = \"frame\" src=\"http://www.etc.cmu.edu/projects/up-plus/images/frame.png\" style=\"position:absolute; left:525px; top:18px; width:250px; height:500px; z-index:1\">");
