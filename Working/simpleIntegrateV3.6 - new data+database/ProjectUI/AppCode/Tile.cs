...
public class Tile
{
    ...
    public string GetHtml()
    {
        ...
        if (path == "http://www.etc.cmu.edu/projects/up-plus/images/tiles/build-in/mail_L.png")
        {
            ...
            htmlString = "<div class=apps style=\"background:url('" + path + "'); background-size:205px 99px; background-color:" + color + "; left:" + x.ToString() + "; top:" + y.ToString() + "; width: 205 px; height: 99px; position: absolute\">";
