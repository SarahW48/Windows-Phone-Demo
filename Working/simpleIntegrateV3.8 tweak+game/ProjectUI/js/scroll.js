$(document).ready(function () {
    ...
    var levelCaption = ["Which one?", "Favorite animal?", "Favorite animal?",
        ...
        if (level == (levelLength + 1)) {
            ...
            if (level == levelLength) {
                ...
                if (levelImg[level] == 2) {
                    ...
                    $("#A").attr('src', "http://www.etc.cmu.edu/projects/up-plus/journey_images/" + level + 'a.jpg');
                    $("#B").attr('src', "http://www.etc.cmu.edu/projects/up-plus/journey_images/" + level + 'b.jpg');
                }
                if (levelImg[level] == 6) {
                    $("#C").css('display', 'block');
                    $("#D").css('display', 'block');
                    ...
                    $("#A").attr('src', "http://www.etc.cmu.edu/projects/up-plus/journey_images/" + level + 'a.jpg');
                    $("#B").attr('src', "http://www.etc.cmu.edu/projects/up-plus/journey_images/" + level + 'b.jpg');
                    $("#C").attr('src', "http://www.etc.cmu.edu/projects/up-plus/journey_images/" + level + 'c.jpg');
                    $("#D").attr('src', "http://www.etc.cmu.edu/projects/up-plus/journey_images/" + level + 'd.jpg');
                    $("#E").attr('src', "http://www.etc.cmu.edu/projects/up-plus/journey_images/" + level + 'e.jpg');
                    $("#F").attr('src', "http://www.etc.cmu.edu/projects/up-plus/journey_images/" + level + 'f.jpg');
