...
namespace ProjectUI.AppCode
{
    public class template6
    {
        ...
        {
            new Startpoint(0,0),new Startpoint(1,0),new Startpoint(2,0),new Startpoint(3,0),new Startpoint(0,3),new Startpoint(1,3),
            new Startpoint(2,3),new Startpoint(3,3),new Startpoint(0,4),new Startpoint(1,4),new Startpoint(2,6),new Startpoint(3,6)
        };
        Startpoint[] pre_medium = new Startpoint[2]
        {
            new Startpoint(2,4),new Startpoint(0,5)
        };
