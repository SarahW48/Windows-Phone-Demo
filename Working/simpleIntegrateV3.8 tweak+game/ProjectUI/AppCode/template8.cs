...
namespace ProjectUI.AppCode
{
    public class template8
    {
        ...
        {
            new Startpoint(0,0),new Startpoint(1,0),new Startpoint(2,0),new Startpoint(3,0),new Startpoint(0,1),new Startpoint(3,1),
            new Startpoint(0,2),new Startpoint(3,2),new Startpoint(2,3),new Startpoint(3,3),new Startpoint(2,4),new Startpoint(3,4)
        };
        Startpoint[] pre_medium = new Startpoint[2]
        {
            new Startpoint(1,1),new Startpoint(0,3)
        };
