...
namespace ProjectUI.AppCode
{
    public class GenerateTileInfo
    {
        ...
        static string[] MailText = {//这个地方到时候再改成不同的说的话，第一行应该是题目，第二行是内容
                                       "<font size=\"1\" color=\"white\">RE:Let's go see a movie this weekend?<br>Just ordered one! Let's have some fun ...", //Games
                                       "<font size=\"1\" color=\"white\">RE:Let's go see a movie this weekend?<br>Sound's like a good plan to me. I don't...",//Music
                                       "<font size=\"1\" color=\"white\">RE:Let's go see a movie this weekend?<br>Sound's like a good plan to me. I don't...",//Video&Movie
                                       "<font size=\"1\" color=\"white\">RE:Let's go see a movie this weekend?<br>Just got my computer. There are also ...",  //Camera&Photo
                                       "<font size=\"1\" color=\"white\">RE:Let's go see a movie this weekend?<br>I got that too... Well, as far as I know,", //News
                                       "<font size=\"1\" color=\"white\">RE:Let's go see a movie this weekend?<br>Hey! Check this out! LOS ANGELES (AP) —...",//Sports
                                       "<font size=\"1\" color=\"white\">RE:Let's go see a movie this weekend?<br>Your Shipping Confirmation! View this ... ",//Shopping&Finance
                                       "<font size=\"1\" color=\"white\">RE:Let's go see a movie this weekend?<br>Sarah just told me there is a party at ...",//Social
                                       "<font size=\"1\" color=\"white\">RE:Let's go see a movie this weekend?<br>$30 to Spend on Wings, Burgers, and ...",  //Food&Restaurants
                                       "<font size=\"1\" color=\"white\">RE:Let's go see a movie this weekend?<br>Picking the best of anything is always...",//Books&Refernce
                                       "<font size=\"1\" color=\"white\">RE:Let's go see a movie this weekend?<br>Forgot the name. But I am pretty sure that...",//Organization
                                       "<font size=\"1\" color=\"white\">RE:Let's go see a movie this weekend?<br>The following information summarizes ...",//Travel&Navigation
                                       "<font size=\"1\" color=\"white\">RE:Let's go see a movie this weekend?<br>The park is holding it again this weekend...",//Fitness
                                   };

        static string[,] AppName = { // the name of each app
                                       {"Game","Game","Game","Game","Game","Game","Game","Game","Game","Game","Games"},//Games
        ...
        static string[] GameName = { "Doodle jump", "Angry birds", "", "" }; // the name of game category
            ...
            if (currentTemplate.getSmall().Count > 0)
            {
                ...
                foreach (KeyValuePair<Startpoint, string> pair in currentTemplate.getSmall())
                {
                    ...
                    else if ((controller == 1 || controller == 2) && (game == "A" || game == "B" || game == "C" || game == "D" || game == "F" || game == "G" || game == "J" || game == "I"))//if not the oldest two
                    {
                        ...
                        name = GameName[controller - 1]; // the name of game catergory
                    ...
                    else
                    {
                        ...
                        if ((controller2 == 0) && (family == "E" || family == "I"))//if the youngest two
                        {
