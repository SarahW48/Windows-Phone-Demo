...
namespace ProjectUI.AppCode
{
    public class template4
    {
        ...
        {
            new Startpoint(0,0),new Startpoint(1,0),new Startpoint(0,1),new Startpoint(1,1),new Startpoint(0,4),new Startpoint(1,4),
            new Startpoint(2,4),new Startpoint(3,4)
        };
        Startpoint[] pre_medium = new Startpoint[3]
        {
            new Startpoint(2,0),new Startpoint(0,5),new Startpoint(2,5)
        };
