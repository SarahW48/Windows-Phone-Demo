...
<script language="javascript" type="text/javascript">
    ...
    $(function () {
        ...
        var appDescription = {
            ...
            "http://www.etc.cmu.edu/projects/up-plus/images/tiles/Social/1.png": "<p>Talk2Me</p>Send and receive recorded voice messages to other Talk2Me users. Supports Fast App Resume, Push Notifications and two side tiles. Trial has no limits and is ad supported.",
            "http://www.etc.cmu.edu/projects/up-plus/images/tiles/Social/2.png": "<p>Kik Messenger</p>14 million users love Kik! It is the fast, simple, and personal smartphone messenger that connects you to everyone you love to talk to.",
            "http://www.etc.cmu.edu/projects/up-plus/images/tiles/Social/3.png": "<p>Holidays Calendar</p>Holidays Calendar is a nice and simple app that lists various types of holidays: career holidays, national and international holidays, special days and more.",
        ...
        $(".tweakbar1").click(function () {
            ...
            //$("#tweakbar2").animate({ "right": "+=400px" }, "slow");
            $(".tweakbar2").show('slide', { direction: 'left' }, 1000);
            ...
            //$(".tweakbar1").slideToggle("fast");
            //$("#tweakbar2").slideToggle("fast");
            //$("#tweakbar2").hide('slide', { direction: 'left' }, 0);
            //$("#tweakbar2").slideToggle("slow");
            //$("#tweakbar1").slideToggle("slow");
            //$("#tweakbar2").css("visibility", "visible");
            //$('#tweakbar2').slideDown('slow', function () { });
            //$("#tweakbar2").show('slide', { direction: 'left' }, 0);
        })
        ...
        $("#changeappsbutton").click(function () {
            if ($("#appsinput").css("display") == "block")
                return;
            if ($("#largeappsinput").css("display") == "block")
                return;
            if ($(".tweakbg").css("display") == "none")
                $(".tweakbg").show('slide', { direction: 'left' }, 1000);


            /* if ($("#templateinput").css("display") == "block")
            $("#templateinput").slideToggle("fast");*/
            $("#templateinput").hide();
            $("#colorinput").hide();
        ...
        $("#changetmplbutton").click(function () {
            /*var tmplateId = $("#curTemplateId").html(); //document.getElementById("templateId").innerHTML;
            for (var i = 0; i < 3; i++) {
            var tpmls = tmplPool[i].toString();
            if (tpmls.charAt(tmplateId) > -1) {
