...
namespace ProjectUI.AppCode
{
    public class template5
    {
        ...
        {
            new Startpoint(0,0),new Startpoint(1,0),new Startpoint(2,2),new Startpoint(3,2),new Startpoint(0,5),new Startpoint(1,5),
            new Startpoint(2,5),new Startpoint(3,5),new Startpoint(0,6),new Startpoint(1,6),new Startpoint(2,6),new Startpoint(3,6)
        };
        Startpoint[] pre_medium = new Startpoint[2]
        {
            new Startpoint(2,0),new Startpoint(0,1)
        };
